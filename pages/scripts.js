...
function set_key_tables(){
   $.getJSON('https://github.com/ArnoFoerster/GW100/tree/master/data/formulas.json', function(data){
       for (x in cas){
...
function load_set(n){
    $.getJSON( "https://github.com/ArnoFoerster/GW100/tree/master/data/" 
...
function make_box(){
    ...
    for (var i = 0; i < sets.length; i++){
        $.getJSON( "https://github.com/ArnoFoerster/GW100/tree/master/data/" + sets[i] + ".json", function(data) {
            var meta = {};
            var vals = [];
...
function make_matrix(){
    ...
    for (var j = 0; j < data_set_names.length; j++){
        $.getJSON( "https://github.com/ArnoFoerster/GW100/tree/master/data/" + data_set_names[j] + ".json", function(data) {
            var meta = {};
            var vals = [];
            for (var key in meta_keys) {
                meta[meta_keys[key]] = data[meta_keys[key]];
